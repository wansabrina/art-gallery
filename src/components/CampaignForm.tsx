...
export default function CampaignForm() {
  ...
  register("displayName", {required: {value: true, message: "First Name is required.",}, minLength: {value: 4, message: "Minimum 4.",},});
  ...
  register("arttitle", {required: {value: true, message: "Art Title is required.",}, maxLength: {value: 30, message: "Maximum 30 character.",},});
  register("artdesc", {required: {value: true, message: "Art Description is required.",}, maxLength: {value: 200,message: "Maximum 200 character.",},});
        ...
        {isSubmitSuccessful ? (
          ...
          <div className="w-1/2.5 h-5/6 flex flex-row py-20">
            <form onSubmit={handleSubmit((data) => {console.log(data);})} className="flex flex-col gap-y-3">
              ...
              <InputField type="text" label="Display Name" name="displayName" register={register} errors={errors} />
              <InputField type="text" label="Email" name="email" register={register} errors={errors} />
              <InputField type="text" label="Art Title" name="arttitle" register={register} errors={errors} />
              ...
              <p className="mt-2  text-sm text-black">Dont have account?{" "}
                <a href="LogIn" className="font-medium text-blue-500 hover:underline">Log in</a>{" "}or{" "}<a href="RegisterForm" className="font-medium text-blue-500 hover:underline">Register here.</a>
              </p>
