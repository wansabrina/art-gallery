...
export default function CampaignPage() {
        return (
            ...
            <Navbar/>
            <div>
                <div className='pt-24 pb-14 flex flex-col items-center justify-center' style={{ backgroundImage: 'url("img/43202.jpg")'}}>
                    <h1 className="mb-4 text-5xl font-extrabold leading-none tracking-tight text-black font-crimson">Experience art from around the world at our global exhibitions.</h1>
                    <p className="mb-6 text-lg font-normal text-gray-800 text-center lg:text-xl sm:px-16 xl:px-48">Van Gogh's emotionally charged and vividly colorful paintings have become some of the most recognizable and beloved artworks in history.</p>
                </div>
                <div className='mt-10'>
