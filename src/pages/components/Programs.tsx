...
const PictureSection = () => {
  return (
    <div className="flex flex-wrap" id='Programs'>
      <div className="w-full md:w-1/3 bg-cover bg-center h-screen" style={{ backgroundImage: 'url("img/vangogh.jpg")' }}></div>
      <div className="w-full md:w-2/3 bg-yellow-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">Improve your drawing skills with in-person classes.</p>
              ...
              <div className="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 ">Learn to paint with expert instructors in a studio setting.</p>
